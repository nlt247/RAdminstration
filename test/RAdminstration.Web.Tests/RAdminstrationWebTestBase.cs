...
{
    public abstract class RAdminstrationWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static RAdminstrationWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(RAdminstrationWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<RAdminstrationDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<RAdminstrationDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<RAdminstrationDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<RAdminstrationDbContext, Task<T>> func)
        {
            T result;
